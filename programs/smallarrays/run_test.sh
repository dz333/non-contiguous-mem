...
cset shield --exec -- perf stat -r 10 -e cycles -e instructions -e cache-misses -e cache-references ./scan_opt 1000 10000000000
...
echo "Using optimized Arrays"
cset shield --exec -- perf stat -r 10 -e cycles -e instructions -e cache-misses -e cache-references ./scan_opt 1000000 10000000000
